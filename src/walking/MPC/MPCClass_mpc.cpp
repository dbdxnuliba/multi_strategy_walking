...
// 	_stepheight(6) = 0.052;	
// 	_stepheight(7) = 0.052;
// 	_stepheight(10) =-0.052;	
// 	_stepheight(11) =-0.052;
// 	_stepheight(12) =-0.052;
...
/////=========================================constraints initialize========================================
	...
	_footy_min=RobotParaClass::HALF_HIP_WIDTH() +0.02;
...
// 	  _alphathetax =1; _alphathetay = 1;
// 	  _beltathetax = 1000; _beltathetay = 1000;
	  //////for Tstep=0.8s, _nh=13;
	  _Rx = 1;            _Ry = 10;            _Rz =1;
	  _alphax = 50;       _alphay = 50;        _alphaz = 100; 
	  _beltax = 10000;    _beltay = 1000;     _beltaz = 20000000;
	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
	  _Rthetax = 1; _Rthetay = 1;
	  _alphathetax =1; _alphathetay = 1;
	  _beltathetax = 1000; _beltathetay = 1000;	  
...
// 	    if ((j_index>=13)&&(j_index<=15))
// 	    {
//  	      cout<<"_Lfootx_plan:"<<_footxyz_real.row(1)<<endl;
...
// 	     _Lfooty(j_index+1) = _Lfooty(j_index);
// 	    }
...
Vector3d MPCClass::X_CoM_position_squat(int walktime, double dt_sample)
{
  ...
  if (t_des<=_height_squat_time)
  {
    ...
    com_squat_plan(2) = RobotParaClass::Z_C(); 
    com_squat_plan(3) = RobotParaClass::Z_C()-_height_offset/2;
    com_squat_plan(4) = RobotParaClass::Z_C()-_height_offset;  
    com_squat_plan(5) = 0;                   
    com_squat_plan(6) = 0;
