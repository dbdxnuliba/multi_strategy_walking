...
/*	       cout<<"_walkdtime1*_dtx:"<<_walkdtime1*_dtx<<endl;
	       cout<<"PelvisPos:"<<PelvisPos<<endl;
               cout<<"LeftFootPosx"<<LeftFootPosx.transpose()<<endl;
	       cout<<"total_mass"<<RobotPara().totalmass<<endl;	       
	       cout<<"*****************************"<<endl;	*/      	      
	    }
	    else
	    {      
      ...
      // // get the optimized footsteps: second method: use the generated reference trajectory at each 0.05s and intepolated trajectory : used in real time
		...
		comxyzx = PelvisPos = mpc.XGetSolution_CoM_position(_walkdtime1, _dtx,COM_in1,COM_in2,COM_in3);              
		thetaxyx = body_thetax = mpc.XGetSolution_body_inclination(_walkdtime1, _dtx, body_in1,body_in2,body_in3);	  
		Lfootxyzx = LeftFootPosx = mpc.XGetSolution_Foot_positionL(_walkdtime1, _dtx, FootL_in1,FootL_in2,FootL_in3);
		Rfootxyzx = RightFootPosx = mpc.XGetSolution_Foot_positionR(_walkdtime1, _dtx, FootR_in1,FootR_in2,FootR_in3);
		
	       cout<<"PelvisPos:"<<PelvisPos<<endl;
               cout<<"LeftFootPosx:"<<LeftFootPosx.transpose()<<endl;
	       cout<<"RightFootPosx:"<<RightFootPosx<<endl;	       
	       cout<<"*****************************"<<endl;		
